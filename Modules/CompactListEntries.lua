...
local function desiredHeight()
    ...
    return GroupinatorSettings.compactListEntries and 36 or templateHeight
end

function GRP.CompactListEntries_UpdateListScrollBox()
...
function GRP.CompactListEntries_UpdateListEntry(self)
    self.Playstyle:SetShown(not GroupinatorSettings.compactListEntries)
    self:SetHeight(desiredHeight())
end

hooksecurefunc("LFGListSearchEntry_Update", GRP.CompactListEntries_UpdateListEntry)
PVEFrame:HookScript("OnShow", function () GRP.CompactListEntries_UpdateListScrollBox() end)
