...
function GRP.InitSpecializations()
...
function GRP.GetAllSpecializations()
    return specs
end

--- Attemps to get the correct specialization info based on the class and localized specialization name
--- as returned by GRP.GetSearchResultMemberInfo
function GRP.GetSpecializationInfoByLocalizedName(class, specLocalized)
...
function GRP.GetSpecializationInfoForPlayer()
