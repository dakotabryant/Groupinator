...
C.MAP_ID_TO_KEYWORDS = {
    ...
    [ 568] = { "tbc", "cata", "za" }, -- Zul'Aman -- also a Cataclysm dungeon with the same mapID
    ...
    [ 644] = { "cata", "hoo" }, -- Halls of Origination
    [ 645] = { "cata", "bc" }, -- Blackrock Caverns
    [ 657] = { "cata", "vp", "dfs2" }, -- Vortex Pinnacle
    [ 670] = { "cata", "gb", "twws1" }, -- Grim Batol
    [ 725] = { "cata", "sc" }, -- The Stonecore
    [ 755] = { "cata", "tv" }, -- Lost City of the Tol'vir
    [ 859] = { "cata", "zg" }, -- Zul'Gurub -- classic ZG has a different mapID
    [ 938] = { "cata", "et" }, -- End Time
    [ 939] = { "cata", "woe" }, -- Well of Eternity
    [ 940] = { "cata", "hot" }, -- Hour of Twilight
    ...
    [2293] = { "sl", "top", "twws2" }, -- Theater of Pain
...
function GRP.PutActivityKeywords(env, activityID)
