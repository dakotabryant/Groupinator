...
L["message.settingsupgraded"] = "Groupinator: 設置遷移到版本 %s"
...
L["dialog.sorting"] = "排序"
L["dialog.usepgf.tooltip"] = "啟用或停用 Groupinator。"
L["dialog.usepgf.usage"] = "為了獲得最大數量的相關結果，請將搜索框與GRP一起使用，因為伺服器返回的結果數量有限。"
L["dialog.usepgf.results.server"] = "伺服器發送的隊伍: |cffffffff%d|r"
L["dialog.usepgf.results.removed"] = "被GRP隱藏的隊伍: |cffffffff%d|r"
...
L["dialog.notdeclined.tooltip"] = "隱藏拒絕您的隊伍。"
...
L["settings.specIcon.title"] = "顯示專精"
L["settings.specIcon.tooltip"] = "在預組隊伍列表中顯示每個成員的職業專精圖示。"
L["settings.missingRoles.title"] = "顯示缺少的角色"
L["settings.missingRoles.tooltip"] = "在預組隊伍列表中顯示每個空位的角色圖示。"
L["settings.signUpDeclined.title"] = "申請被拒絕的隊伍"
L["settings.signUpDeclined.tooltip"] = "恢復 TWW 之前的舊行為，允許再次申請之前拒絕你的隊伍。"
L["settings.section.mythicplus.title"] = "傳奇+"
L["settings.section.signup.title"] = "報名"
L["settings.rioRatingColors.title"] = "使用Raider.IO顏色評分"
