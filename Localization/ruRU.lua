...
L["message.settingsupgraded"] = "Groupinator: Настройки перенесены в версию %s"
L["message.sortingoverwritten"] = "Groupinator: Порядок сортировки групп по умолчанию был изменен аддоном %s."
L["message.sortingrestored"] = "Groupinator: Порядок сортировки групп по умолчанию был восстановлен аддоном %s."
...
L["dialog.usepgf.tooltip"] = "Включить/отключить Groupinator"
L["dialog.usepgf.usage"] = "Чтобы получить максимальное количество релевантных результатов, используйте поисковую строку вместе с GRP, так как количество результатов, возвращаемых сервером, ограничено."
L["dialog.usepgf.results.server"] = "Группы, отправленные сервером: |cffffffff%d|r"
L["dialog.usepgf.results.removed"] = "Группы, скрытые GRP: |cffffffff%d|r"
...
L["dialog.blfit.tooltip"] = "Если ни у кого в Вашей группе нет 'Кровожадности' или 'Героизма', то показывать только те группы, в которых уже есть 'Кровожадность' или 'Героизм', иначе после присоединения к ним все еще есть свободный слот для бойца или целителя. Также работает, если Вы один."
...
L["dialog.needsbl.tooltip"] = "Показывает только те группы, в которых нет класса, предоставляющего 'Кровожадность' или 'Героизм'"
...
L["dialog.button.selectinvert.tooltip"] = "Инвертировать выбор"

L["settings.dialogMovable.title"] = "Перемещаемое окно GRP"
L["settings.dialogMovable.tooltip"] = "Позволяет перемещать окно GRP с помощью мыши. ПКМ - сбрасывает положение."
