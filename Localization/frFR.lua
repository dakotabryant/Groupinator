...
L["addon.name.short"] = "GRP"
L["addon.name.long"] = "Groupinator"
...
L["message.settingsupgraded"] = "Groupinator : paramètres migrés vers la version %s"
L["message.sortingoverwritten"] = "Groupinator : l’ordre de tri des groupes prédéfinis par défaut a été remplacé par l’addon %s."
L["message.sortingrestored"] = "Groupinator : l’ordre de tri des groupes prédéfinis par défaut a été restauré par l’addon %s."
...
L["dialog.delvetier"]  = "Niveau de Gouffres"
L["dialog.delvetier.tooltip"] = "Certains joueurs ne définissent pas correctement le niveau des Gouffres, mais le mentionnent uniquement dans le nom du groupe. Les addons ne peuvent pas lire le nom. Utilisez le champ de recherche standard pour de meilleurs résultats."
L["dialog.defeated"]   = "Boss de raid vaincus"
L["dialog.sorting"] = "Tri"
L["dialog.usepgf.tooltip"] = "Activer / désactiver Groupinator"
L["dialog.usepgf.usage"] = "Pour obtenir des résultats pertinents, utilisez le champ de recherche en même temps que GRP, car le nombre de résultats renvoyés par le serveur est limité."
L["dialog.usepgf.results.server"] = "Groupes affichés par le serveur : |cffffffff%d|r"
L["dialog.usepgf.results.removed"] = "Groupes cachés par GRP : |cffffffff%d|r"
L["dialog.usepgf.results.displayed"] = "Groupes affichés par GRP : |cffffffff%d|r"
...
L["dialog.filters.delves"] = "Gouffres"
...
L["settings.dialogMovable.title"] = "Déverrouiller la fenêtre GRP"
L["settings.dialogMovable.tooltip"] = "Verrouiller / déverrouiller la fenêtre Groupinator. Clic droit pour réinitialiser la position."
...
L["settings.rioRatingColors.tooltip"] = "Si l’addon Raider.IO est installé et chargé, GRP utilisera la palette de couleur définie par Raider.IO."
