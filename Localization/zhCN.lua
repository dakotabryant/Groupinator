...
L["message.noplaystylefix"] = "Groupinator: 不会修复“接口操作因AddOn而失败”错误，因为您似乎没有完全安全的帐户，否则无法创建预制队伍。请参阅插件常见问题解答以获取更多信息以及如何解决此问题。"
L["message.settingsupgraded"] = "Groupinator: 设置迁移到版本 %s"
...
L["dialog.sorting"] = "排序"
L["dialog.usepgf.tooltip"] = "启用或停用 Groupinator。"
L["dialog.usepgf.usage"] = "为了获得最大数量的相关结果，请将搜索框与GRP一起使用，因为服务器返回的结果数量有限。"
L["dialog.usepgf.results.server"] = "服务器的队伍: |cffffffff%d|r"
L["dialog.usepgf.results.removed"] = "GRP隐藏的队伍: |cffffffff%d|r"
...
L["dialog.notdeclined.tooltip"] = "隐藏已拒绝您的队伍"
L["dialog.blfit"] = "嗜血/英勇 筛选"
L["dialog.blfit.tooltip"] = "如果您的队伍中没人拥有嗜血/英勇，则勾选后将帮您过滤出已有嗜血/英勇的队伍；或者您加入后，仍有空位的队伍。当然，您独自申请队伍时，本项仍然适用。"
L["dialog.brfit"] = "战复筛选"
...
L["settings.specIcon.tooltip"] = "在预创建队伍列表中显示每个成员的专精图标。"
L["settings.missingRoles.title"] = "显示缺少的职责"
L["settings.missingRoles.tooltip"] = "在预创建队伍列表中显示每个空栏的职责图标。"
L["settings.signUpDeclined.title"] = "应用于被拒绝的队伍"
L["settings.signUpDeclined.tooltip"] = "恢复地心之战（TWW）之前的旧行为，允许加入之前拒绝您的队伍。"
L["settings.section.mythicplus.title"] = "史诗+"
