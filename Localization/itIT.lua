...
L["message.settingsupgraded"] = "Groupinator: Impostazioni trasferite alla versione %s"
...
L["dialog.heroic"] = "Eroica"
L["dialog.mythic"] = "Mitica"
...
L["dialog.usepgf.tooltip"] = "Abilita o disabilita Groupinator."
L["dialog.usepgf.usage"] = "Per ottenere il numero massimo di risultati pertinenti, utilizza la casella di ricerca insieme a GRP, poiché il numero di risultati restituiti dal server è limitato."
L["dialog.usepgf.results.server"] = "Gruppi inviati dal server: |cffffffff%d|r"
L["dialog.usepgf.results.removed"] = "Gruppi nascosti da GRP: |cffffffff%d|r"
...
L["dialog.matchingid"] = "ID Incursione"
...
L["settings.specIcon.title"] = "Mostra la specializzazione"
L["settings.specIcon.tooltip"] = "Mostra un'icona con la specializzazione di classe di ogni membro nella lista dei gruppi preimpostati."
L["settings.missingRoles.title"] = "Mostra i ruoli mancanti"
L["settings.missingRoles.tooltip"] = "Mostra l'icona del ruolo di ogni slot vuoto nella lista dei gruppi preimpostati."
L["settings.signUpDeclined.title"] = "Iscriviti ai gruppi rifiutati"
L["settings.signUpDeclined.tooltip"] = "Ripristina il vecchio comportamento prima di TWW e permetti di iscriversi di nuovo ai gruppi che ti hanno precedentemente rifiutato."
L["settings.section.mythicplus.title"] = "Mitica+"
L["settings.section.signup.title"] = "Iscriviti"
L["settings.rioRatingColors.title"] = "Punteggio nei colori di Raider.IO"
