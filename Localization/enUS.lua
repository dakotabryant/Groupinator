...
L["message.settingsupgraded"] = "Groupinator: Migrated settings to version %s"
L["message.sortingoverwritten"] = "Groupinator: Default premade group sorting order has been overwritten by addon %s."
L["message.sortingrestored"] = "Groupinator: Default premade group sorting order has been restored by addon %s."
...
L["dialog.usepgf.tooltip"] = "Enable or disable Groupinator."
L["dialog.usepgf.usage"] = "To get maximum number of relevant results, use the search box together with GRP, as the number of results returned by the server is limited."
L["dialog.usepgf.results.server"] = "Groups sent by server: |cffffffff%d|r"
L["dialog.usepgf.results.removed"] = "Groups hidden by GRP: |cffffffff%d|r"
...
L["dialog.playstyle"] = "Playstyle .........................."
L["dialog.playstyle.learning"] = "Learning"
L["dialog.playstyle.relaxed"] = "Relaxed"
L["dialog.playstyle.competitive"] = "Competitive"
L["dialog.playstyle.carry"] = "Carry Offered"
L["dialog.tooltip.fresh"] = "group posted < 2 min ago"
L["dialog.tooltip.recent"] = "group posted < 10 min ago"
L["dialog.tooltip.playstyle"] = "filter by playstyle tag"
