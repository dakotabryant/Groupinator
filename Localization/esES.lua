...
L["message.settingsupgraded"] = "Groupinator: Configuración migrada a la versión %s"
...
L["dialog.usepgf.tooltip"] = "Activa o desactiva Groupinator"
...
L["settings.specIcon.title"] = "Mostrar especialización"
L["settings.specIcon.tooltip"] = "Muestra un icono con la especialización de clase de cada miembro en la lista de grupos prediseñados."
L["settings.missingRoles.title"] = "Mostrar roles faltantes"
L["settings.missingRoles.tooltip"] = "Muestra el icono del rol de cada espacio vacío en la lista de grupos prediseñados."
L["settings.signUpDeclined.title"] = "Inscribirse a grupos rechazados"
L["settings.signUpDeclined.tooltip"] = "Restaura el comportamiento antiguo antes de TWW y permite inscribirse en grupos que previamente te rechazaron."
L["settings.section.mythicplus.title"] = "Mítica+"
L["settings.section.signup.title"] = "Inscribirse"
L["settings.rioRatingColors.title"] = "Calificación en colores de Raider.IO"
