...
L["error.semantic.protected"] = "|cffff0000Semantischer Fehler im Filterausdruck|r\n\nDie Filterausdrücke 'name' und 'comment' werden nicht mehr unterstützt. Bitte entferne sie aus deinem Filterausdruck oder drücke die Zurücksetzen-Schaltfläche.\n\nAb dem Battle for Azeroth Prepatch sind diese Werte durch Blizzard geschützt und können von keinem Addon mehr ausgewertet werden.\n\nBenutze das Standardsuchfeld oberhalb der Gruppenauflistung, um nach Gruppenname zu filtern.\n\nTechnische Fehlermeldung:\n|cffaaaaaa%s|r"
L["message.settingsupgraded"] = "Groupinator: Einstellungen auf Version %s migriert"
L["message.sortingoverwritten"] = "Groupinator: Die standardmäßige Sortierreihenfolge organisierter Gruppen wurde durch das Addon %s überschrieben."
L["message.sortingrestored"] = "Groupinator: Die standardmäßige Sortierreihenfolge organisierter Gruppen wurde durch das Addon %s wiederhergestellt."
...
L["dialog.delvetier"]  = "Tiefen-Stufe ............................"
L["dialog.delvetier.tooltip"] = "Einige Spieler setzen die Stufe nicht korrekt, sondern erwähnen sie nur im Gruppennamen. Addons können den Namen nicht auslesen. Verwende das Standard-Suchfeld für bessere Ergebnisse."
L["dialog.defeated"]   = "Besiegte Raid-Bosse"
L["dialog.sorting"] = "Sortierung"
L["dialog.usepgf.tooltip"] = "Groupinator aktivieren oder deaktivieren."
L["dialog.usepgf.usage"] = "Um maximale viele relevante Ergebnisse zu erhalten, benutzt das Suchfeld zusammen mit GRP, da die Anzahl vom Server zurückgegebener Ergebnisse begrenzt ist."
L["dialog.usepgf.results.server"] = "Vom Server gesendete Gruppen: |cffffffff%d|r"
L["dialog.usepgf.results.removed"] = "Durch GRP ausgeblendete Gruppen: |cffffffff%d|r"
...
L["dialog.filters.delves"] = "Tiefen"
...
L["dialog.notdeclined.tooltip"] = "Verstecke Gruppen, die euch abgelehnt haben."
...
L["settings.rioRatingColors.title"] = "Wertung in Raider.IO-Farben"
