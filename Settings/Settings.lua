...
local PGFSettings = CreateFrame("Frame", "GroupinatorSettingsFrame", nil, "GroupinatorSettingsTemplate")
local PGFSettingsTable = {
    ...
    },
    {
        ...
        visible = GRP.IsRetail(),
        callback = function(value) GRP.CompactListEntries_UpdateListScrollBox() end,
    },
    {
        type = "header",
    ...
    },
    {
        ...
        image = "Interface\\AddOns\\Groupinator\\Textures\\SettingsRatingInfo",
        visible = true,
    },
    {
        key = "rioRatingColors",
    ...
    },
    {
        ...
        image = "Interface\\AddOns\\Groupinator\\Textures\\SettingsSpecIcon",
        visible = GRP.SupportsSpecializations(),
    },
    {
        key = "classCircle",
        type = "checkbox",
    ...
    },
    {
        ...
        image = "Interface\\AddOns\\Groupinator\\Textures\\SettingsClassBar",
        visible = true,
    },
    {
        key = "leaderCrown",
        ...
        image = "Interface\\AddOns\\Groupinator\\Textures\\SettingsLeaderCrown",
        visible = true,
    },
    {
        key = "missingRoles",
        ...
        image = "Interface\\AddOns\\Groupinator\\Textures\\SettingsMissingRoles",
        visible = GRP.SupportsDragonflightUI(),
    },
    {
        type = "header",
    ...
    },
    {
        ...
        visible = true,
        callback = function(value) GRP.PersistSignUpNote() end,
    },
    {
        key = "signupOnEnter",
        type = "checkbox",
...
function PGFSettings:OnLoad()
    ...
    GRP.settingsCategory = category
end

function PGFSettings.CreateListItem(factory, elementData)
    if elementData.type == "checkbox" then
        factory("GroupinatorSettingsCheckBoxTemplate", function(item, elementData)
            ...
            item.CheckBox:SetChecked(GroupinatorSettings[elementData.key] or false)
            item.CheckBox:SetScript("OnClick", function(button, buttonName, down)
                GroupinatorSettings[elementData.key] = button:GetChecked()
                if elementData.callback then
                    elementData.callback(button:GetChecked())
                end
            end)
            if GRP.SupportsDragonflightUI() and elementData.image then
                item.Image:SetTexture(elementData.image)
            end
        end)
    elseif elementData.type == "header" then
        factory("GroupinatorSettingsListSectionHeaderTemplate", function(item, elementData)
...
function GRP.OpenSettings()
    Settings.OpenToCategory(GRP.settingsCategory.ID)
end
