...
GRP.StaticPopupDialogs = {
    ...
    ["GRP_CONFIRM_RESET"] = {
        ...
        button1 = OKAY,
        button2 = CANCEL,
        OnAccept = function (self) GRP.Dialog:Reset() end,
        hideOnEscape = true,
    },
    ["GRP_COPY_URL_KEYWORDS"] = {
...
local PGFStaticPopup = CreateFrame("Frame", "GroupinatorStaticPopup", UIParent, "GroupinatorStaticPopupTemplate")
...
function PGFStaticPopup:OnButtonClick(index)
    local info = GRP.StaticPopupDialogs[self.which]
...
function GRP.StaticPopup_Show(which, text_arg1, text_arg2)
