...
local RBGPanel = CreateFrame("Frame", "GroupinatorRBGPanel", GRP.Dialog, "GroupinatorRBGPanelTemplate")

function RBGPanel:OnLoad()
    GRP.Logger:Debug("RBGPanel:OnLoad")
    self.name = "rbg"
...
function RBGPanel:Init(state)
    GRP.Logger:Debug("RBGpanel:Init")
    self.state = state
...
function RBGPanel:OnShow()
    GRP.Logger:Debug("RBGPanel:OnShow")
end

function RBGPanel:OnHide()
    GRP.Logger:Debug("RBGPanel:OnHide")
end

function RBGPanel:OnReset()
    GRP.Logger:Debug("RBGPanel:OnReset")
...
function RBGPanel:OnUpdateExpression(expression, sorting)
    GRP.Logger:Debug("RBGPanel:OnUpdateExpression")
    self.state.expression = expression
    self:Init(self.state)
end

function RBGPanel:TriggerFilterExpressionChange()
    GRP.Logger:Debug("RBGPanel:TriggerFilterExpressionChange")
...
function RBGPanel:GetFilterExpression()
    GRP.Logger:Debug("RBGPanel:GetFilterExpression")
...
RBGPanel:OnLoad()
GRP.Dialog:RegisterPanel("c9f8", RBGPanel)
