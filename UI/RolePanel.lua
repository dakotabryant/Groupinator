...
local RolePanel = CreateFrame("Frame", "GroupinatorRolePanel", GRP.Dialog, "GroupinatorRolePanelTemplate")

function RolePanel:OnLoad()
    GRP.Logger:Debug("RolePanel:OnLoad")
    self.name = "role"
...
function RolePanel:Init(state)
    GRP.Logger:Debug("RolePanel:Init")
    self.state = state
...
function RolePanel:OnShow()
    GRP.Logger:Debug("RolePanel:OnShow")
end

function RolePanel:OnHide()
    GRP.Logger:Debug("RolePanel:OnHide")
end

function RolePanel:OnReset()
    GRP.Logger:Debug("RolePanel:OnReset")
...
function RolePanel:OnUpdateExpression(expression, sorting)
    GRP.Logger:Debug("RolePanel:OnUpdateExpression")
    self.state.expression = expression
    self:Init(self.state)
end

function RolePanel:TriggerFilterExpressionChange()
    GRP.Logger:Debug("RolePanel:TriggerFilterExpressionChange")
...
function RolePanel:GetFilterExpression()
    GRP.Logger:Debug("RolePanel:GetFilterExpression")
...
RolePanel:OnLoad()
GRP.Dialog:RegisterPanel("role", RolePanel)
